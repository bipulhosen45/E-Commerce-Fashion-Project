        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <a href="{{ route('create.role') }}" class="btn btn-primary" > <i class="fa-circle fa-plus"></i> Add New</a>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                   ...
                   @foreach($data as $key=>$row) 	
                    <tr>
                      ...
                      <td>
                      	...
                      	@if($row->user_role==1) <span class="badge badge-success">userrole</span>@endif
                      </td>
