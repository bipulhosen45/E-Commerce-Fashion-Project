		...
		<div class="row">
			...
			<div class="col-lg-1 order-lg-1 order-2" >
				...
				@isset($images)	
					...
					<li data-image="{{ asset('backend/files/product/'.$image) }}">
			...
			<div class="col-lg-4 order-3">
				...
				<div class="product_description">
					...
					<div><br>
                    <div class="text-danger" style="margin-top: 35px; font-size: 20px;">Price: {{ $setting->currency }}{{$product_price->price}}</div>
					 ...
					 @foreach($related_product as $row)		
						...
						<div class="owl-item">
							<div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
								<div class="viewed_image"><img src="{{ asset('backend/files/product/'.$row->thumbnail) }}" alt="{{ $row->name }}"></div>
