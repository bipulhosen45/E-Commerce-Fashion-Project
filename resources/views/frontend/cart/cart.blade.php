                        ...
                        <ul class="cart_list">
                            ...
                            <li class="cart_item clearfix">
                                ...
                                <div class="cart_item_image mt-3">
                                     <img src="{{ asset('backend/files/product/'.$row->options->thumbnail) }}" width="70%" height="70%" alt="">
                                </div>
                                <div class="cart_item_info d-flex flex-md-row row flex-column justify-content-between">
                                    <div class="cart_item_name cart_info_col col-sm-2">
                                        <div class="cart_item_text">{{ substr($row->name,0,15) }}..</div>
                                    </div>
                                    @if($row->options->size !=NULL)
                                    <div class="cart_item_color cart_info_col col-sm-1">
                                    ...
                                    <div class="cart_item_color cart_info_col col-sm-1" style="margin-left:4%; margin-right:4%">
                                        <div class="cart_item_text">
                                    ...
                                    <div class="cart_item_quantity cart_info_col col-sm-1">
                                        <div class="cart_item_text">
                                            <input type="number" class="form-control form-control-sm qty custom_css" name="qty" data-id="{{ $row->rowId }}"  value="{{ $row->qty }}" min="1" required="">
                                        </div>
                                    </div>

                                    <div class="cart_item_price cart_info_col col-sm-2">
                                        
                                        <div class="cart_item_text">{{ $setting->currency }}{{ $row->price }} x {{$row->qty }}</div>
                                    </div>
                                    <div class="cart_item_total cart_info_col col-sm-2" style="margin-left:-4%; margin-right:-4%">
                                        <div class="cart_item_text">{{ $setting->currency }} {{ $row->qty*$row->price }}</div>
                                        
                                    </div>
                                    <div class="cart_item_total cart_info_col col-sm-1">
                                        
                                        <div class="cart_item_text text-danger">
                                            <a href="#" data-id="{{ $row->rowId }}" id="removeProduct"><i class="fa-solid fa-xmark text-danger"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
