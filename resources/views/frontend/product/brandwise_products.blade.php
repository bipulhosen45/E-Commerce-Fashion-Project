                ...
                <div class="product_grid row">
                    ...
                    @foreach($products as $row)
                        <div class="product_item is_new">
                            ...
                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('backend/files/product/'.$row->thumbnail) }}" width="" height="90%" alt=""></div>
