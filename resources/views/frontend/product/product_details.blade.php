...
$sizes =explode(',', $product->size);
 ...
 $product_review=App\Models\Review::where('product_id',$product->id)->first();
...
@endphp
                ...
                <div class="col-lg-1 order-lg-1 order-2">
                    <ul class="image_list">
                        ...
                        <li data-image="{{asset('backend/files/product/'.$image)}}" alt="">
							<img src="{{asset('backend/files/product/'.$image)}}" alt="">
						</li>	
						@endforeach
                        @endisset
                    </ul>
                ...
                <div class="col-lg-4 order-lg-2 order-1">
                    <div class="image_selected"><img src="{{asset('backend/files/product/'.$product->thumbnail)}}" alt=""></div>
                </div>
                ...
                <div class="col-lg-4 order-3 mb-5">
                    <div class="product_description">
                        ...
                        <div class="order_info d-flex flex-row" style="margin-top: 1%">
                            <form action="{{route('add.to.cart.quickview')}}" method="POST" id="add_to_cart">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        @isset($product->size)
                                        <div class="col-lg-6">
                                            <label for="" class="m-2">Size: </label>
                                            <select class="form-control form-control-sm custom_css" name="size">
										...
										@isset($product->color)
                                        <div class="col-lg-6">
                                            <label for="" class="m-2">Color: </label>
                                            <select name="color" id="" class="form-control form-control-sm custom_css">
                                ...
                                <div class="clearfix" style="z-index: 1000;" style="margin-top: 5%">
                                    <!-- Product Quantity -->
                                    <div class="product_quantity clearfix mt-3">
                                        <span class="text-dark"><b>Quantity:</b> </span>
                                        <input id="quantity_input" class="" name="qty" type="text" pattern="[1-9]*" value="1">
                                ...
                                <div class="button_container" style="margin-top: 5%">
                                    <div class="input-group-prepend">
                                        ...
                                        <button class="btn btn-outline-danger" disabled style="margin-right: 5px">Stock Out</button>
                                        @else
                                        <button type="submit" class="btn btn-outline-info" style="margin-right: 5px"><span class="loading d-none">...</span> Add to Cart</button>
                                        @endif
                                        <a href="{{route('add.wishlist', $product->id)}}" type="button" class="btn btn-outline-primary"><i class="fa-solid fa-heart"></i> Wishlist</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        {{-- Social link --}}
                        <div id="social-links mt-5 d-flex">
                            <ul class="d-flex" style="margin-top: 100px">
                                <li class="d-flex ">
                                    <a href="https://www.facebook.com/sharer/sharer.php?u=http://jorenvanhocht.be" class="social-button " id=""><i class="fa-brands fa-facebook"></i></a>
                                </li>
                                <li class="d-flex mx-2">
                                    <a href="https://twitter.com/intent/tweet?text=my share text&amp;url=http://jorenvanhocht.be" class="social-button " id=""><i class="fa-brands fa-twitter"></i></a>
                                </li>
                                <li class="d-flex mx-2">
                                    <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=http://jorenvanhocht.be&amp;title=my share text&amp;summary=dit is de linkedin summary" class="social-button " id=""><i class="fa-brands fa-linkedin"></i></span></a>
                                </li>
                                <li class="d-flex mx-2">
                                    <a href="https://wa.me/?text=http://jorenvanhocht.be" class="social-button " id=""><i class="fa-brands fa-square-whatsapp"></i></a>
                                </li>    
                                <li class="d-flex mx-2">
                                    <a href="https://wa.me/?text=http://jorenvanhocht.be" class="social-button " id=""><i class="fa-brands fa-square-instagram"></i></a>
                                </li>    
                                <li class="d-flex mx-2">
                                    <a href="https://wa.me/?text=http://jorenvanhocht.be" class="social-button " id=""><i class="fa-brands fa-facebook-messenger"></i></a>
                                </li>    
                                <li class="d-flex mx-2">
                                    <a href="https://wa.me/?text=http://jorenvanhocht.be" class="social-button " id=""><i class="fa-solid fa-envelope"></i></a>
                                </li>    
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div>
                                        ...
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        <span> Total <span class="font-weight-bold">{{$review_5}}</span></span>
                                    </div>
                                    <div>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        ...
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star"></span>
                                        <span> Total <span class="font-weight-bold">{{$review_4}}</span></span>
                                    </div>
                                    <div>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        ...
                                        <span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                                        <span> Total <span class="font-weight-bold">{{$review_3}}</span></span>
                                    </div>
                                    <div>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        ...
                                        <span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                                        <span> Total <span class="font-weight-bold">{{$review_2}}</span></span>
                                    </div>
                                    <div>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star"></span>
                                        ...
                                        <span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                                        <span> Total <span class="font-weight-bold">{{$review_1}}</span></span>
                                    </div>
                                ...
                                <div class="owl-item">
                                    <a href="{{ route('product.details', $row->slug) }}">
                                        ...
                                        <div class="viewed_content text-center">
                                            ...
                                            @else
                                                <div class="viewed_price">{{ $setting->currency }}{{ $row->discount_price }}
                                                    <span>{{ $setting->currency }}{{ $row->selling_price }}</span></div>
                                            @endif
 ...
 @push('js')
 <script src="{{asset('fronted')}}/js/share.js"></script>
