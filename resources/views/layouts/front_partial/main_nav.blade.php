                ...
                <div class="main_nav_content d-flex flex-row">
                        ...
                        <ul class="cat_menu">
                            ...
                            <li class="hassubs">
                                <a href="{{route('categorywise.product', $row->id)}}">
                                    <img src="{{ asset('backend/files/category/'.$row->icon) }}" height="18" width="18"> {{$row->category_name}}<i class="fas fa-chevron-right"></i>
                                </a>
                                <ul>
                    ...
                    <div class="main_nav_menu ml-auto">
                        <ul class="standard_dropdown main_nav_dropdown">
                            ...
                            <li><a href="{{route('contact')}}">Helpline<i class="fas fa-chevron-down"></i></a></li>
                            <li><a href="{{route('blog')}}">Our Blog<i class="fas fa-chevron-down"></i></a></li>
                        </ul>
                    </div>
            ...
            <div class="col">
                ...
                <div class="page_menu_content">
                    ...
                    <ul class="page_menu_nav">
                        ...
                        <li class="page_menu_item"><a href="{{route('blog')}}">Our Blog<i class="fa fa-angle-down"></i></a></li>
                        <li class="page_menu_item"><a href="{{route('contact')}}">Contact<i class="fa fa-angle-down"></i></a></li>
                    </ul>
                    
                    <div class="menu_contact">
                        <div class="menu_contact_item"><div class="menu_contact_icon"><img src="{{asset('fronted')}}/images/phone_white.png" alt=""></div>+38 068 005 3570</div>
                        <div class="menu_contact_item"><div class="menu_contact_icon"><img src="{{asset('fronted')}}/images/mail_white.png" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a></div>
                    </div>
                </div>
            </div>
        </div>
